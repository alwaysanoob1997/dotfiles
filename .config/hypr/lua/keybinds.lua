...
hl.bind(altMod .. " + M", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
hl.bind(altMod .. " + Q", hl.dsp.exec_cmd(locker))
hl.bind(altMod .. " + W", hl.dsp.exec_cmd("waypaper --random"))
